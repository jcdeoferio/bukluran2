...
The <?=$organization['orgname']?> has listed you as Faculty Adviser of the in their application for university recognition.<?=br(2)?>

You can confirm your membership to the organization by going to:<?=br(2)?>

<?=anchor('login/link/'.$faculty['hashcode'],site_url('login/link/'.$faculty['hashcode'])).br(2)?>

Your code for logging in is: <b><?= $faculty['hashcode']?></b><?=br(2)?>
